...
add wave -noupdate -group {IV Signals/Data} -label {Vector No.} -radix unsigned /xm23_cpu/vect_num
add wave -noupdate -group {IV Signals/Data} -label IV_Cnt -radix binary /xm23_cpu/ctrl_unit/iv_cnt
add wave -noupdate -group {IV Signals/Data} -label CEX_State_In /xm23_cpu/cex_state_in
add wave -noupdate -group {IV Signals/Data} -label PIC_in /xm23_cpu/pic_in
add wave -noupdate -group {IV Signals/Data} -label CPU_OP -radix decimal /xm23_cpu/ctrl_unit/cpu_OP
add wave -noupdate -group {IV Signals/Data} -label CPU_WB /xm23_cpu/ctrl_unit/cpu_WB
add wave -noupdate -group {IV Signals/Data} -label CPU_INC /xm23_cpu/ctrl_unit/cpu_INC
add wave -noupdate -group {IV Signals/Data} -label CPU_DEC /xm23_cpu/ctrl_unit/cpu_DEC
add wave -noupdate -group {IV Signals/Data} -label CPU_PRPO /xm23_cpu/ctrl_unit/cpu_PRPO
add wave -noupdate -group {IV Signals/Data} -label PC_FLT /xm23_cpu/ctrl_unit/PC_FLT
add wave -noupdate -group {IV Signals/Data} -label DBL_FLT /xm23_cpu/ctrl_unit/DBL_FLT
add wave -noupdate -group {IV Signals/Data} -label PRI_FLT /xm23_cpu/ctrl_unit/PRI_FLT
add wave -noupdate -group {IV Signals/Data} -label IV_Enter /xm23_cpu/ctrl_unit/iv_enter
add wave -noupdate -group {IV Signals/Data} -label IV_Return /xm23_cpu/ctrl_unit/iv_return
add wave -noupdate -group {IV Signals/Data} -label SVC_Inst /xm23_cpu/ctrl_unit/svc_inst
add wave -noupdate -group {IV Signals/Data} -label SVC_in_Prog -radix binary /xm23_cpu/ctrl_unit/iv_ent/svc_in_prog
add wave -noupdate -group {IV Signals/Data} -label In_Fault /xm23_cpu/ctrl_unit/in_fault
add wave -noupdate -group {IV Signals/Data} -label Prev_Pri -radix unsigned /xm23_cpu/ctrl_unit/prev_priority
add wave -noupdate -group {IV Signals/Data} -label PSW_Bus_Ctrl_IV /xm23_cpu/ctrl_unit/psw_bus_ctrl_iv
add wave -noupdate -group {IV Signals/Data} -label IV_Cnt_RST /xm23_cpu/ctrl_unit/iv_cnt_rst
add wave -noupdate -group {IV Signals/Data} -label PSW_Entry_Update /xm23_cpu/ctrl_unit/psw_entry_update
add wave -noupdate -group {IV Signals/Data} -label Clear_CEX /xm23_cpu/ctrl_unit/clear_cex
add wave -noupdate -group {IV Signals/Data} -label Load_CEX /xm23_cpu/ctrl_unit/load_cex
add wave -noupdate -group {IV Signals/Data} -label CLR_SLP_Bit /xm23_cpu/ctrl_unit/clr_slp_bit
add wave -noupdate -group {IV Signals/Data} -label Rec_Pre_Pri /xm23_cpu/ctrl_unit/rec_pre_pri
add wave -noupdate -group {IV Signals/Data} -label Call_Pri_FLT /xm23_cpu/ctrl_unit/call_pri_flt
add wave -noupdate -group {IV Signals/Data} -label Use_PIC_Vect /xm23_cpu/ctrl_unit/use_pic_vect
add wave -noupdate -group {IV Signals/Data} -label Operands /xm23_cpu/ctrl_unit/operands
add wave -noupdate -group {IV Signals/Data} -label Word_Byte /xm23_cpu/ctrl_unit/word_byte
add wave -noupdate -group {IV Signals/Data} -label INC_IV /xm23_cpu/ctrl_unit/inc_iv
add wave -noupdate -group {IV Signals/Data} -label DEC_IV /xm23_cpu/ctrl_unit/dec_iv
add wave -noupdate -group {IV Signals/Data} -label PRPO_IV /xm23_cpu/ctrl_unit/prpo_iv
add wave -noupdate -group {IV Signals/Data} -label IV_CPU_RST /xm23_cpu/ctrl_unit/iv_cpu_rst
add wave -noupdate -group {IV Signals/Data} -label Data_Bus_Ctrl_IV /xm23_cpu/ctrl_unit/data_bus_ctrl_iv
add wave -noupdate -group {IV Signals/Data} -label Addr_Bus_Ctrl_IV /xm23_cpu/ctrl_unit/addr_bus_ctrl_iv
add wave -noupdate -group {IV Signals/Data} -label OP_IV -radix decimal /xm23_cpu/ctrl_unit/OP_iv
add wave -noupdate -group {IV Signals/Data} -label Data_SRC_IV -radix unsigned /xm23_cpu/ctrl_unit/data_src_iv
add wave -noupdate -group {IV Signals/Data} -label Addr_SRC_IV -radix unsigned /xm23_cpu/ctrl_unit/addr_src_iv
add wave -noupdate -group {IV Signals/Data} -label Data_DST_IV -radix unsigned /xm23_cpu/ctrl_unit/data_dst_iv
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/data_reg_kb
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/data_reg_scr
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/CSR_kb_i
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/CSR_scr_i
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/data_bus_i
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/data_bus_o
add wave -noupdate -expand -group dev -group arduino_i /xm23_cpu/kb_scr/control_i
add wave -noupdate -expand -group dev -group arduino_i /xm23_cpu/kb_scr/write_en
add wave -noupdate -expand -group dev -group arduino_i /xm23_cpu/kb_scr/read_ok
add wave -noupdate -expand -group dev -group arduino_o /xm23_cpu/kb_scr/control_o
add wave -noupdate -expand -group dev -group arduino_o /xm23_cpu/kb_scr/read_en
add wave -noupdate -expand -group dev -group arduino_o /xm23_cpu/kb_scr/write_ok
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/CSR_scr_o
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/CSR_kb_o
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/scr_of_o
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/scr_dba_o
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/kb_of_o
add wave -noupdate -expand -group dev /xm23_cpu/kb_scr/kb_dba_o
add wave -noupdate -expand -group dev -expand -group scr_i /xm23_cpu/kb_scr/scr_en_i
add wave -noupdate -expand -group dev -expand -group scr_i /xm23_cpu/kb_scr/scr_of_i
add wave -noupdate -expand -group dev -expand -group scr_i /xm23_cpu/kb_scr/scr_dba_i
add wave -noupdate -expand -group dev -expand -group scr_i /xm23_cpu/kb_scr/scr_io_i
add wave -noupdate -expand -group dev -expand -group scr_i /xm23_cpu/kb_scr/scr_ie_i
add wave -noupdate -expand -group dev -group kb_i /xm23_cpu/kb_scr/kb_en_i
add wave -noupdate -expand -group dev -group kb_i /xm23_cpu/kb_scr/kb_of_i
add wave -noupdate -expand -group dev -group kb_i /xm23_cpu/kb_scr/kb_dba_i
add wave -noupdate -expand -group dev -group kb_i /xm23_cpu/kb_scr/kb_io_i
add wave -noupdate -expand -group dev -group kb_i /xm23_cpu/kb_scr/kb_ie_i
add wave -noupdate -expand -group {cpu dev} -expand /xm23_cpu/dev_mem
add wave -noupdate -expand -group {cpu dev} /xm23_cpu/arduino_data_i
add wave -noupdate -expand -group {cpu dev} /xm23_cpu/arduino_data_o
add wave -noupdate -expand -group {cpu dev} /xm23_cpu/arduino_ctrl_i
add wave -noupdate -expand -group {cpu dev} /xm23_cpu/arduino_ctrl_o
